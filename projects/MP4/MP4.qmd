...
format:
  html:
    code-links:
      - text: Cleaning Code
        href: https://github.com/gwynniehayes/gwynniehayes.github.io/blob/main/index.qmd
---

# Change cleaning code link!!
...
- Is power more similar to itself then the other albums?   
...
smartFreeIH |>
  ...
  labs(x = "Word Count", y = "Word", title = "10 Most Common Words in All Songs") 
...
smartFreeIH |>
  ...
  labs(x = "Word Count", y = "Word", title = "10 Most Common Words in Each Album")
```
